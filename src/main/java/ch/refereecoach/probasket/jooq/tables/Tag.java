...
public class Tag extends TableImpl<TagRecord> {
    ...
    public ReportVideoCommentTagPath reportVideoCommentTag() {
        if (_reportVideoCommentTag == null)
            _reportVideoCommentTag = new ReportVideoCommentTagPath(this, null, Keys.REPORT_VIDEO_COMMENT_TAG__FK__REPORT_VIDEO_COMMENT_TAG_TAG.getInverseKey());
    ...
    public ReportVideoCommentPath reportVideoComment() {
        return reportVideoCommentTag().reportVideoComment();
    }
