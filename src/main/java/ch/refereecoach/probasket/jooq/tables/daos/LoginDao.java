...
public class LoginDao extends AbstractSpringDAOImpl<LoginRecord, ch.refereecoach.probasket.jooq.tables.pojos.Login, Long> {
    ...
    /**
     * Fetch records that have <code>basketplan_username BETWEEN lowerInclusive
     * AND upperInclusive</code>
     */
    public List<ch.refereecoach.probasket.jooq.tables.pojos.Login> fetchRangeOfBasketplanUsername(String lowerInclusive, String upperInclusive) {
        return fetchRange(Login.LOGIN.BASKETPLAN_USERNAME, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>basketplan_username IN (values)</code>
     */
    public List<ch.refereecoach.probasket.jooq.tables.pojos.Login> fetchByBasketplanUsername(String... values) {
        return fetch(Login.LOGIN.BASKETPLAN_USERNAME, values);
    }

    /**
     * Fetch a unique record that has <code>basketplan_username = value</code>
     */
    public ch.refereecoach.probasket.jooq.tables.pojos.Login fetchOneByBasketplanUsername(String value) {
        return fetchOne(Login.LOGIN.BASKETPLAN_USERNAME, value);
    }

    /**
     * Fetch a unique record that has <code>basketplan_username = value</code>
     */
    public Optional<ch.refereecoach.probasket.jooq.tables.pojos.Login> fetchOptionalByBasketplanUsername(String value) {
        return fetchOptional(Login.LOGIN.BASKETPLAN_USERNAME, value);
    }
