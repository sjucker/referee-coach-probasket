...
public class Login extends TableImpl<LoginRecord> {
    ...
    /**
     * The column <code>public.login.basketplan_username</code>.
     */
    public final TableField<LoginRecord, String> BASKETPLAN_USERNAME = createField(DSL.name("basketplan_username"), SQLDataType.VARCHAR(255).nullable(false), this, "");
