...
public class Report extends TableImpl<ReportRecord> {
     ...
     */
    public final TableField<ReportRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).generatedByDefaultAsIdentity(), this, "");
    ...
    public Report where(Condition condition) {
        return new Report(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Report whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Report whereNotExists(TableLike<?> select) {
