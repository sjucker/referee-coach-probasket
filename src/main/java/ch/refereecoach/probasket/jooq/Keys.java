...
public class Keys {
    ...
    public static final ForeignKey<ReportVideoCommentRefRecord, ReportVideoCommentRecord> REPORT_VIDEO_COMMENT_REF__FK__REPORT_REPORTEE = Internal.createForeignKey(ReportVideoCommentRef.REPORT_VIDEO_COMMENT_REF, DSL.name("fk__report_reportee"), new TableField[] { ReportVideoCommentRef.REPORT_VIDEO_COMMENT_REF.REPORT_VIDEO_COMMENT_ID }, Keys.PK__REPORT_VIDEO_COMMENT, new TableField[] { ReportVideoComment.REPORT_VIDEO_COMMENT.ID }, true);
