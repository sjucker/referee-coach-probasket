...
import {PATH_ADMIN, PATH_CHANGE_PASSWORD, PATH_EXPORT, PATH_LOGIN, PATH_OVERVIEW, PATH_TAG_SEARCH} from "../../app.routes";
...
export class Header {
    ...
    protected readonly PATH_EXPORT = PATH_EXPORT;
    protected readonly PATH_CHANGE_PASSWORD = PATH_CHANGE_PASSWORD;
